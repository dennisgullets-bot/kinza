...
const ue = window,
    Ot = ue.trustedTypes,
    Tr = Ot ? Ot.createPolicy("lit-html", {
        createHTML: e => e
    }) : void 0,
    lr = "$lit$",
...
const Fo = (e, t) => {
    ...
    for (let a = 0; a < r; a++) {
        ...
        let c, d, b = -1,
            u = 0;
        for (; u < l.length && (s.lastIndex = u, d = s.exec(l), d !== null);) u = s.lastIndex, s === Rt ? d[1] === "!--" ? s = kr : d[1] !== void 0 ? s = Mr : d[2] !== void 0 ? (ao.test(d[2]) && (o = RegExp("</" + d[2], "g")), s = lt) : d[3] !== void 0 && (s = lt) : s === lt ? d[0] === ">" ? (s = o ? ? Rt, b = -1) : d[1] === void 0 ? b = -2 : (b = s.lastIndex - d[2].length, c = d[1], s = d[3] === void 0 ? lt : d[3] === '"' ? Sr : Pr) : s === Sr || s === Pr ? s = lt : s === kr || s === Mr ? s = Rt : (s = lt, o = void 0);
        const m = s === lt && e[a + 1].startsWith("/>") ? " " : "";
        i += s === Rt ? l + Ho : b >= 0 ? (n.push(c), l.slice(0, b) + lr + l.slice(b) + rt + m) : l + rt + (b === -2 ? (n.push(void 0), a) : m)
    }
            ...
            if (o.nodeType === 1) {
                ...
                if (ao.test(o.tagName)) {
                    ...
                    if (u > 0) {
                        ...
                        for (let m = 0; m < u; m++) o.append(b[m], Zt()), ut.nextNode(), l.push({
                            type: 2,
                            index: ++i
                        });
                        o.append(b[u], Zt())
...
function It(e, t, r = e, n) {
    var o, i, s, a;
    if (t === pt) return t;
    let l = n !== void 0 ? (o = r._$Co) === null || o === void 0 ? void 0 : o[n] : r._$Cl;
    const c = Vt(t) ? void 0 : t._$litDirective$;
    return (l == null ? void 0 : l.constructor) !== c && ((i = l == null ? void 0 : l._$AO) === null || i === void 0 || i.call(l, !1), c === void 0 ? l = void 0 : (l = new c(e), l._$AT(e, r, n)), n !== void 0 ? ((s = (a = r)._$Co) !== null && s !== void 0 ? s : a._$Co = [])[n] = l : r._$Cl = l), l !== void 0 && (t = It(e, l._$AS(e, t.values), l, n)), t
}
class Zo {
    constructor(t, r) {
...
class Jt {
    ...
    _$AI(t, r = this) {
        t = It(this, t, r), Vt(t) ? t === B || t == null || t === "" ? (this._$AH !== B && this._$AR(), this._$AH = B) : t !== this._$AH && t !== pt && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : zo(t) ? this.T(t) : this._(t)
    }
    k(t) {
...
class ve {
    ...
    _$AI(t, r = this, n, o) {
        ...
        let s = !1;
        if (i === void 0) t = It(this, t, r, 0), s = !Vt(t) || t !== this._$AH && t !== pt, s && (this._$AH = t);
        else {
            const a = t;
            let l, c;
            for (t = i[0], l = 0; l < i.length - 1; l++) c = It(this, a[n + l], r, l), c === pt && (c = this._$AH[l]), s || (s = !Vt(c) || c !== this._$AH[l]), c === B ? t = B : t !== B && (t += (c ? ? "") + i[l + 1]), this._$AH[l] = c
        }
        s && !o && this.j(t)
    }
    j(t) {
...
class Yo extends ve {
    ...
    _$AI(t, r = this) {
        var n;
        if ((t = (n = It(this, t, r, 0)) !== null && n !== void 0 ? n : B) === pt) return;
        const o = this._$AH,
...
class wo {
    constructor(t, r = [0, 1], {
        ...
        if (this.startTime = null, this.rate = 1, this.t = 0, this.cancelTimestamp = null, this.easing = it, this.duration = 0, this.totalDuration = 0, this.repeat = 0, this.playState = "idle", this.finished = new Promise((b, u) => {
        ...
        this.tick = b => {
            ...
            i = i;
            let m = 0;
            this.pauseTime !== void 0 ? m = this.pauseTime : m = (b - this.startTime) * this.rate, this.t = m, m /= 1e3, m = Math.max(m - i, 0), this.playState === "finished" && this.pauseTime === void 0 && (m = this.totalDuration);
            const v = m / this.duration;
            let g = Math.floor(v),
                E = v % 1;
            !E && v >= 1 && (E = 1), E === 1 && g--;
            const f = g % 2;
            (c === "reverse" || c === "alternate" && f || c === "alternate-reverse" && !f) && (E = 1 - E);
            const y = m >= this.totalDuration ? 1 : Math.min(E, 1),
                w = d(this.easing(y));
            t(w), this.pauseTime === void 0 && (this.playState === "finished" || m >= this.totalDuration + s) ? (this.playState = "finished", (u = this.resolve) === null || u === void 0 || u.call(this, w)) : this.playState !== "idle" && (this.frameRequestId = requestAnimationFrame(this.tick))
        }, this.play()
    }
    play() {
...
const Me = (e, t) => document.createElement("div").animate(e, t),
    ...
    Pe = {},
    Ct = {};
for (const e in jr) Ct[e] = () => (Pe[e] === void 0 && (Pe[e] = jr[e]()), Pe[e]);
const _n = .015,
    On = (e, t) => {
        let r = "";
    ...
    Hr = (e, t) => Tt(e) ? Ct.linearEasing() ? `linear(${On(e,t)})` : H.easing : fo(e) ? In(e) : e,
    In = ([e, t, r, n]) => `cubic-bezier(${e}, ${t}, ${r}, ${n})`;

function Tn(e, t) {
    for (let r = 0; r < e.length; r++) e[r] === null && (e[r] = r ? e[r - 1] : t());
    return e
}
const kn = e => Array.isArray(e) ? e : [e];
...
function Sn(e, t, r, n = {}, o) {
    ...
    const p = hr(t),
        I = pn(f.values, p),
        T = qt.get(p);
    return yo(I.animation, !(cr(u) && I.generator) && n.record !== !1), () => {
        const R = () => {
            var M, F;
            return (F = (M = Xt.get(e, p)) !== null && M !== void 0 ? M : T == null ? void 0 : T.initialValue) !== null && F !== void 0 ? F : 0
        };
        let k = Tn(kn(r), R);
        const z = Mn(k, T);
        if (cr(u)) {
            const M = u.createAnimation(k, t !== "opacity", R, p, I);
            u = M.easing, k = M.keyframes || k, l = M.duration || l
        }
        if (dr(p) && (Ct.cssRegisterProperty() ? An(p) : w = !1), y && !Ct.linearEasing() && (Tt(u) || Et(u) && u.some(Tt)) && (w = !1), w) {
            T && (k = k.map(Z => me(Z) ? T.toDefaultUnit(Z) : Z)), k.length === 1 && (!Ct.partialKeyframes() || s) && k.unshift(R());
            const M = {
                delay: zt.ms(c),
                duration: zt.ms(l),
                endDelay: zt.ms(d),
                easing: Et(u) ? void 0 : Hr(u, l),
                direction: v,
                iterations: b + 1,
                fill: "both"
            };
            a = e.animate({
                [p]: k,
                offset: g,
                easing: Et(u) ? u.map(Z => Hr(Z, l)) : void 0
            }, M), a.finished || (a.finished = new Promise((Z, V) => {
                a.onfinish = Z, a.oncancel = V
            }));
            const F = k[k.length - 1];
            a.finished.then(() => {
                m || (Xt.set(e, p, F), a.cancel())
            }).catch(mo), E || (a.playbackRate = 1.000001)
        } else if (o && y) k = k.map(M => typeof M == "string" ? parseFloat(M) : M), k.length === 1 && k.unshift(parseFloat(R())), a = new o(M => {
            Xt.set(e, p, z ? z(M) : M)
        }, k, Object.assign(Object.assign({}, n), {
            duration: l,
            easing: u
        }));
        else {
            const M = k[k.length - 1];
            Xt.set(e, p, T && me(M) ? T.toDefaultUnit(M) : M)
        }
        return s && i(e, t, k, {
            duration: l,
            delay: c,
...
(function(e) {
    ...
    e.isValid = function(o) {
        ...
        for (let b = 0; b < i; b++) {
            ...
            for (let u = 0; u < i; u++) {
                let m = o.get(b, u);
                m === c ? a++ : (a >= 5 && (s += t.N1 + (a - 5)), c = m, a = 1), m = o.get(u, b), m === d ? l++ : (l >= 5 && (s += t.N1 + (l - 5)), d = m, l = 1)
            }
...
(function(e) {
    ...
    function l(u, m, v) {
        for (let g = 1; g <= 40; g++)
            if (m <= e.getCapacity(g, v, u)) return g
    }
...
const ur = j,
    Po = 1335,
    ei = 21522,
    Fr = ur.getBCHDigit(Po);
Mo.getEncodedBits = function(t, r) {
    const n = t.bit << 3 | r;
    let o = n << 10;
    for (; ur.getBCHDigit(o) - Fr >= 0;) o ^= Po << ur.getBCHDigit(o) - Fr;
    return (n << 10 | o) ^ ei
};
var So = {};
const ri = at;
...
(function(e) {
    ...
    function b(f) {
        const y = d(s.NUMERIC, t.NUMERIC, f),
            w = d(s.ALPHANUMERIC, t.ALPHANUMERIC, f);
        let p, I;
        return a.isKanjiModeEnabled() ? (p = d(s.BYTE, t.BYTE, f), I = d(s.KANJI, t.KANJI, f)) : (p = d(s.BYTE_KANJI, t.BYTE, f), I = []), y.concat(w, p, I).sort(function(R, k) {
    ...
    function m(f) {
        return f.reduce(function(y, w) {
            ...
            return p && p.mode === w.mode ? (y[y.length - 1].data += w.data, y) : (y.push(w), y)
        }, [])
    }
        ...
        for (let T = 0; T < f.length; T++) {
            ...
            for (let z = 0; z < R.length; z++) {
                ...
                for (let Z = 0; Z < I.length; Z++) {
                    const V = I[Z];
                    w[V] && w[V].node.mode === M.mode ? (p[V][F] = u(w[V].lastCount + M.length, M.mode) - u(w[V].lastCount, M.mode), w[V].lastCount += M.length) : (w[V] && (w[V].lastCount = M.length), p[V][F] = u(M.length, M.mode) + 4 + t.getCharCountIndicator(M.mode, y))
                }
            }
            I = k
        }
        for (let T = 0; T < I.length; T++) p[I[T]].end = 0;
        return {
            map: p,
            table: w
        }
    ...
    function E(f, y) {
        ...
        if (w = t.from(y, p), w !== t.BYTE && w.bit < p.bit) throw new Error('"' + f + '" cannot be encoded with mode ' + t.toString(w) + `.
 Suggested mode is: ` + t.toString(p));
    ...
    e.fromArray = function(y) {
        return y.reduce(function(w, p) {
            return typeof p == "string" ? w.push(E(p, null)) : p.data && w.push(E(p.data, p.mode)), w
        }, [])
    }, e.fromString = function(y, w) {
        const p = b(y, a.isKanjiModeEnabled()),
            I = v(p),
            T = g(I, w),
            R = l.find_path(T.map, "start", "end"),
            k = [];
        for (let z = 1; z < R.length - 1; z++) k.push(T.table[R[z]].node);
        return e.fromArray(m(k))
...
function Ai(e, t, r) {
    ...
    r.forEach(function(l) {
        n.put(l.mode.bit, 4), n.put(l.getLength(), bi.getCharCountIndicator(l.mode, e)), l.write(n)
    });
...
function _i(e, t, r) {
    ...
    for (let R = 0; R < s; R++) {
        const k = R < l ? d : b;
        g[R] = y.slice(v, v + k), E[R] = m.encode(g[R]), v += k, f = Math.max(f, k)
    }
    const w = new Uint8Array(n);
    let p = 0,
        I, T;
    for (I = 0; I < f; I++)
        for (T = 0; T < s; T++) I < g[T].length && (w[p++] = g[T][I]);
    for (I = 0; I < u; I++)
        for (T = 0; T < s; T++) w[p++] = E[T][I];
    return w
}
...
`);
    const s = Ai(t, r, o),
        a = $e.getSymbolSize(t),
        l = new gi(a);
    return yi(l, t), xi(l), $i(l, t), Ne(l, r, 0), t >= 7 && Ci(l, t), Ei(l, s), isNaN(n) && (n = mr.getBestMask(l, Ne.bind(null, l, r))), mr.applyMask(n, l), Ne(l, r, n), {
        modules: l,
        version: t,
...
$o.create = function(t, r) {
    ...
    let n = Re.M,
        o, i;
    return typeof r < "u" && (n = Re.from(r.errorCorrectionLevel, Re.M), o = we.from(r.version), i = mr.from(r.maskPattern), r.toSJISFunc && $e.setToSJISFunction(r.toSJISFunc)), Oi(t, o, n, i)
};
var Ro = {},
    Cr = {};
(function(e) {
...
(function(e) {
    ...
    e.render = function(i, s, a) {
        ...
        return t.qrToImageData(u.data, i, l), r(b, c, d), b.putImageData(u, 0, 0), c
...
Lo.render = function(t, r, n) {
    const o = Ii.getOptions(r),
        ...
        d = 'viewBox="0 0 ' + a + " " + a + '"',
        u = '<svg xmlns="http://www.w3.org/2000/svg" ' + (o.width ? 'width="' + o.width + '" height="' + o.width + '" ' : "") + d + ' shape-rendering="crispEdges">' + l + c + `</svg>
`;
...
function Er(e, t, r, n, o) {
    ...
    if (!a && !ki()) throw new Error("Callback required as last argument");
    if (a) {
...
var Pi = Object.defineProperty,
    ...
    De = (e, t) => {
        for (var r in t || (t = {})) Si.call(t, r) && Kr(e, r, t[r]);
        if (Vr)
            for (var r of Vr(t)) Ri.call(t, r) && Kr(e, r, t[r]);
        return e
    };
...
const _ = {
    ...
    Ni = P `button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`;
var Bi = Object.defineProperty,
    Di = Object.getOwnPropertyDescriptor,
    wt = (e, t, r, n) => {
        for (var o = n > 1 ? void 0 : n ? Di(t, r) : t, i = e.length - 1, s; i >= 0; i--)(s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let Q = class extends A {
    ...
    render() {
        ...
        let t = "inverse";
        return this.variant === "ghost" && (t = "secondary"), this.variant === "outline" && (t = "accent"), h `<button class="${G(e)}" ?disabled="${this.disabled}" @click="${this.onClick}">${this.iconLeft}<wcm-text variant="small-regular" color="${t}"><slot></slot></wcm-text>${this.iconRight}</button>`
    }
};
Q.styles = [_.globalCss, Ni], wt([$({
    type: Boolean
})], Q.prototype, "disabled", 2), wt([$()], Q.prototype, "iconLeft", 2), wt([$()], Q.prototype, "iconRight", 2), wt([$()], Q.prototype, "onClick", 2), wt([$()], Q.prototype, "variant", 2), Q = wt([O("wcm-button")], Q);
...
let Lt = class extends A {
    ...
    render() {
        ...
        return h `<button ?disabled="${this.disabled}" class="${G(e)}"><slot></slot></button>`
    }
};
Lt.styles = [_.globalCss, Ui], Ue([$({
    type: Boolean
})], Lt.prototype, "disabled", 2), Ue([$()], Lt.prototype, "variant", 2), Lt = Ue([O("wcm-button-big")], Lt);
const Hi = P `:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
...
We.styles = [_.globalCss, Hi], We = Zi([O("wcm-info-footer")], We);
const S = {
    ...
    Vi = P `.wcm-toolbar-placeholder{top:0;bottom:0;left:0;right:0;width:100%;position:absolute;display:block;pointer-events:none;height:100px;border-radius:calc(var(--wcm-background-border-radius) * .9);background-color:var(--wcm-background-color);background-position:center;background-size:cover}.wcm-toolbar{height:38px;display:flex;position:relative;margin:5px 15px 5px 5px;justify-content:space-between;align-items:center}.wcm-toolbar img,.wcm-toolbar svg{height:28px;object-position:left center;object-fit:contain}#wcm-wc-logo path{fill:var(--wcm-accent-fill-color)}button{width:28px;height:28px;border-radius:var(--wcm-icon-button-border-radius);border:0;display:flex;justify-content:center;align-items:center;cursor:pointer;background-color:var(--wcm-color-bg-1);box-shadow:0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-bg-2)}button svg{display:block;object-position:center}button path{fill:var(--wcm-color-fg-1)}.wcm-toolbar div{display:flex}@media(hover:hover){button:hover{background-color:var(--wcm-color-bg-2)}}`;
var Ki = Object.defineProperty,
    qi = Object.getOwnPropertyDescriptor,
    Yi = (e, t, r, n) => {
        for (var o = n > 1 ? void 0 : n ? qi(t, r) : t, i = e.length - 1, s; i >= 0; i--)(s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
        return n && o && Ki(t, r, o), o
    };
let je = class extends A {
    render() {
        return h `<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${S.WALLET_CONNECT_LOGO} <button @click="${ce.close}">${S.CROSS_ICON}</button></div>`
    }
};
je.styles = [_.globalCss, Vi], je = Yi([O("wcm-modal-backcard")], je);
const Ji = P `main{padding:20px;padding-top:0;width:100%}`;
...
He.styles = [_.globalCss, Ji], He = Xi([O("wcm-modal-content")], He);
...
ze.styles = [_.globalCss, ts], ze = os([O("wcm-modal-footer")], ze);
const ns = P `header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
...
let ct = class extends A {
    ...
    backBtnTemplate() {
        return h `<button class="wcm-back-btn" @click="${N.goBack}">${S.BACK_ICON}</button>`
    }
    actionBtnTemplate() {
    ...
    render() {
        ...
        return h `<header class="${G(e)}">${t?this.backBtnTemplate():null} ${r} ${this.onAction?this.actionBtnTemplate():null}</header>`
    }
};
ct.styles = [_.globalCss, ns], Nt([$()], ct.prototype, "title", 2), Nt([$()], ct.prototype, "onAction", 2), Nt([$()], ct.prototype, "actionIcon", 2), Nt([$({
    type: Boolean
...
const x = {
        ...
        getCachedRouterWalletPlatforms() {
            const {
                desktop: e,
                mobile: t
            } = C.getWalletRouterData(), r = !!(e != null && e.native), n = !!(e != null && e.universal), o = !!(t != null && t.native) || !!(t != null && t.universal);
            return {
                isDesktop: r,
                isMobile: o,
                isWeb: n
    ...
    as = P `.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
...
Bt.styles = [_.globalCss, as], Fe([W()], Bt.prototype, "view", 2), Fe([W()], Bt.prototype, "prevView", 2), Bt = Fe([O("wcm-modal-router")], Bt);
const ds = P `div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
...
let re = class extends A {
    ...
    render() {
        ...
        return this.open ? h `<div class="${G(r)}">${t==="success"?S.CHECKMARK_ICON:null} ${t==="error"?S.CROSS_ICON:null}<wcm-text variant="small-regular">${e}</wcm-text></div>` : null
    }
};
re.styles = [_.globalCss, ds], Yr([W()], re.prototype, "open", 2), re = Yr([O("wcm-modal-toast")], re);
const ms = .1,
    Jr = 2.5,
    J = 7;

function Ze(e, t, r) {
    return e === t ? !1 : (e - t < 0 ? t - e : e - t) <= r + ms
}
...
const fs = {
        generate(e, t, r) {
            ...
            l.forEach(({
                ...
                const E = (s.length - J) * a * v,
                    f = (s.length - J) * a * g,
                    y = .45;
                for (let w = 0; w < l.length; w += 1) {
                    const p = a * (J - w * 2);
                    i.push(L `<rect fill="${w%2===0?n:o}" height="${p}" rx="${p*y}" ry="${p*y}" width="${p}" x="${E+a*w}" y="${f+a*w}">`)
                }
            });
            ...
            }), Object.entries(m).map(([v, g]) => {
                const E = g.filter(f => g.every(y => !Ze(f, y, a)));
                return [Number(v), E]
            }).forEach(([v, g]) => {
                g.forEach(E => {
                    i.push(L `<circle cx="${v}" cy="${E}" fill="${n}" r="${a/Jr}">`)
                })
            }), Object.entries(m).filter(([v, g]) => g.length > 1).map(([v, g]) => {
                const E = g.filter(f => g.some(y => Ze(f, y, a)));
                return [Number(v), E]
            }).map(([v, g]) => {
                g.sort((f, y) => f < y ? -1 : 1);
                const E = [];
                for (const f of g) {
                    const y = E.find(w => w.some(p => Ze(f, p, a)));
                    y ? y.push(f) : E.push([f])
                }
                return [v, E.map(f => [f[0], f[f.length - 1]])]
            }).forEach(([v, g]) => {
                g.forEach(([E, f]) => {
                    i.push(L `<line x1="${v}" x2="${v}" y1="${E}" y2="${f}" stroke="${n}" stroke-width="${a/(Jr/2)}" stroke-linecap="round">`)
                })
            }), i
        }
    },
...
let X = class extends A {
    ...
    svgTemplate() {
        ...
        return L `<svg height="${e}" width="${e}">${fs.generate(this.uri,e,e/4)}</svg>`
    }
    render() {
        const e = {
            "wcm-dark": _t.state.themeMode === "dark"
        };
        return h `<div style="${`width: ${this.size}px`}" class="${G(e)}">${this.walletId||this.imageUrl?h`<wcm-wallet-image walletId="${D(this.walletId)}" imageId="${D(this.imageId)}" imageUrl="${D(this.imageUrl)}"></wcm-wallet-image>`:S.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}</div>`
    }
};
X.styles = [_.globalCss, ps], vt([$()], X.prototype, "uri", 2), vt([$({
    type: Number
})], X.prototype, "size", 2), vt([$()], X.prototype, "imageId", 2), vt([$()], X.prototype, "walletId", 2), vt([$()], X.prototype, "imageUrl", 2), X = vt([O("wcm-qrcode")], X);
const bs = P `:host{position:relative;height:28px;width:80%}input{width:100%;height:100%;line-height:28px!important;border-radius:var(--wcm-input-border-radius);font-style:normal;font-family:-apple-system,system-ui,BlinkMacSystemFont,'Segoe UI',Roboto,Ubuntu,'Helvetica Neue',sans-serif;font-feature-settings:'case' on;font-weight:500;font-size:16px;letter-spacing:-.03em;padding:0 10px 0 34px;transition:.2s all ease;color:var(--wcm-color-fg-1);background-color:var(--wcm-color-bg-3);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay);caret-color:var(--wcm-accent-color)}input::placeholder{color:var(--wcm-color-fg-2)}svg{left:10px;top:4px;pointer-events:none;position:absolute;width:20px;height:20px}input:focus-within{box-shadow:inset 0 0 0 1px var(--wcm-accent-color)}path{fill:var(--wcm-color-fg-2)}`;
...
let oe = class extends A {
    ...
    render() {
        return h `<input type="text" @input="${this.onChange}" placeholder="Search wallets"> ${S.SEARCH_ICON}`
    }
};
oe.styles = [_.globalCss, bs], Gr([$()], oe.prototype, "onChange", 2), oe = Gr([O("wcm-search-input")], oe);
const $s = P `@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
...
Dt.styles = [_.globalCss, _s], Ke([$()], Dt.prototype, "variant", 2), Ke([$()], Dt.prototype, "color", 2), Dt = Ke([O("wcm-text")], Dt);
const Ts = P `button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
...
let K = class extends A {
    ...
    render() {
        var e;
        return h `<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${D(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${(e=this.label)!=null?e:x.getWalletName(this.name,!0)}</wcm-text>${this.sublabelTemplate()}</div></button>`
    }
};
K.styles = [_.globalCss, Ts], tt([$()], K.prototype, "onClick", 2), tt([$()], K.prototype, "name", 2), tt([$()], K.prototype, "walletId", 2), tt([$()], K.prototype, "label", 2), tt([$()], K.prototype, "imageId", 2), tt([$({
    type: Boolean
})], K.prototype, "installed", 2), tt([$({
    type: Boolean
})], K.prototype, "recent", 2), K = tt([O("wcm-wallet-button")], K);
const Ps = P `:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
...
let bt = class extends A {
    ...
    render() {
        ...
        return h `${t.length?h`<div><img crossorigin="anonymous" src="${t}" alt="${this.id}"></div>`:S.WALLET_PLACEHOLDER}`
    }
};
bt.styles = [_.globalCss, Ps], ne([$()], bt.prototype, "walletId", 2), ne([$()], bt.prototype, "imageId", 2), ne([$()], bt.prototype, "imageUrl", 2), bt = ne([O("wcm-wallet-image")], bt);
var Ls = Object.defineProperty,
    Ns = Object.getOwnPropertyDescriptor,
    Qr = (e, t, r, n) => {
        for (var o = n > 1 ? void 0 : n ? Ns(t, r) : t, i = e.length - 1, s; i >= 0; i--)(s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
        return n && o && Ls(t, r, o), o
    };
...
Qr([W()], qe.prototype, "preload", 2), qe = Qr([O("wcm-explorer-context")], qe);
...
let et = class extends A {
    ...
    render() {
        ...
        return h `<div class="${G(e)}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${D(this.walletId)}" imageId="${D(this.imageId)}"></wcm-wallet-image></div><wcm-text variant="medium-regular" color="${this.isError?"error":"primary"}">${this.isError?"Connection declined":this.label}</wcm-text>`
    }
};
et.styles = [_.globalCss, Fs], yt([$()], et.prototype, "walletId", 2), yt([$()], et.prototype, "imageId", 2), yt([$({
    type: Boolean
})], et.prototype, "isError", 2), yt([$({
    type: Boolean
})], et.prototype, "isStale", 2), yt([$()], et.prototype, "label", 2), et = yt([O("wcm-connector-waiting")], et);
const At = {
        manualWallets() {
            var e, t;
            const {
                mobileWallets: r,
                desktopWallets: n
            } = gt.state, o = (e = At.recentWallet()) == null ? void 0 : e.id, i = C.isMobile() ? r : n, s = i == null ? void 0 : i.filter(a => o !== a.id);
            return (t = C.isMobile() ? s == null ? void 0 : s.map(({
                id: a,
                name: l,
                links: c
            }) => ({
    ...
    st = {
        ...
        manualWalletsTemplate() {
            return At.manualWallets().map(e => h `<wcm-wallet-button walletId="${e.id}" name="${e.name}" .onClick="${()=>this.onConnecting(e)}"></wcm-wallet-button>`)
        },
        recomendedWalletsTemplate(e = !1) {
            return At.recomendedWallets(e).map(t => h `<wcm-wallet-button name="${t.name}" walletId="${t.id}" imageId="${t.image_id}" .onClick="${()=>this.onConnecting(t)}"></wcm-wallet-button>`)
        },
        recentWalletTemplate() {
            const e = At.recentWallet();
            if (e) return h `<wcm-wallet-button name="${e.name}" walletId="${e.id}" imageId="${D(e.image_id)}" .recent="${!0}" .onClick="${()=>this.onConnecting(e)}"></wcm-wallet-button>`
        }
    },
    Ks = P `.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.wcm-desktop-title,.wcm-mobile-title{display:flex;align-items:center}.wcm-mobile-title{justify-content:space-between;margin-bottom:20px;margin-top:-10px}.wcm-desktop-title{margin-bottom:10px;padding:0 10px}.wcm-subtitle{display:flex;align-items:center}.wcm-subtitle:last-child path{fill:var(--wcm-color-fg-3)}.wcm-desktop-title svg,.wcm-mobile-title svg{margin-right:6px}.wcm-desktop-title path,.wcm-mobile-title path{fill:var(--wcm-accent-color)}`;
...
let Je = class extends A {
    render() {
        ...
        s ? a = i.slice(0, 3) : a = i;
        const l = !!a.length;
        return h `<wcm-modal-header .border="${!0}" title="Connect your wallet" .onAction="${x.handleUriCopy}" .actionIcon="${S.COPY_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-mobile-title"><div class="wcm-subtitle">${S.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">Mobile</wcm-text></div><div class="wcm-subtitle">${S.SCAN_ICON}<wcm-text variant="small-regular" color="secondary">Scan with your wallet</wcm-text></div></div><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>${l?h`<wcm-modal-footer><div class="wcm-desktop-title">${S.DESKTOP_ICON}<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${a} ${s?h`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>`:null}</div></wcm-modal-footer>`:null}`
    }
};
Je.styles = [_.globalCss, Ks], Je = Js([O("wcm-desktop-wallet-selection")], Je);
const Gs = P `div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var Qs = Object.defineProperty,
    Xs = Object.getOwnPropertyDescriptor,
    ta = (e, t, r, n) => {
        for (var o = n > 1 ? void 0 : n ? Xs(t, r) : t, i = e.length - 1, s; i >= 0; i--)(s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
Ge.styles = [_.globalCss, Gs], Ge = ta([O("wcm-legal-notice")], Ge);
const ea = P `div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
...
let Qe = class extends A {
    ...
    render() {
        ...
        s ? a = i.slice(0, 7) : a = i;
        const l = !!a.length;
        return h `<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${S.QRCODE_ICON}"></wcm-modal-header>${l?h`<wcm-modal-content><div>${a} ${s?h`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>`:null}</div></wcm-modal-content>`:null}`
    }
};
Qe.styles = [_.globalCss, ea], Qe = na([O("wcm-mobile-wallet-selection")], Qe);
const ia = P `:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
var sa = Object.defineProperty,
    aa = Object.getOwnPropertyDescriptor,
    Xe = (e, t, r, n) => {
        for (var o = n > 1 ? void 0 : n ? aa(t, r) : t, i = e.length - 1, s; i >= 0; i--)(s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let Ut = class extends A {
    ...
    render() {
        ...
        return h `<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${G(e)}" @click="${this.onCloseModal}" role="alertdialog" aria-modal="true"><div class="wcm-container" tabindex="0">${this.open?h`<wcm-modal-backcard></wcm-modal-backcard><div class="wcm-card"><wcm-modal-router></wcm-modal-router><wcm-modal-toast></wcm-modal-toast></div>`:null}</div></div>`
    }
};
Ut.styles = [_.globalCss, ia], Xe([W()], Ut.prototype, "open", 2), Xe([W()], Ut.prototype, "active", 2), Ut = Xe([O("wcm-modal")], Ut);
const la = P `div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
...
dt.styles = [_.globalCss, la], Wt([$({
    type: Boolean
})], dt.prototype, "isMobile", 2), Wt([$({
    type: Boolean
})], dt.prototype, "isDesktop", 2), Wt([$({
    type: Boolean
})], dt.prototype, "isWeb", 2), Wt([$({
    type: Boolean
})], dt.prototype, "isRetry", 2), dt = Wt([O("wcm-platform-selection")], dt);
const ha = P `button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
...
let tr = class extends A {
    ...
    render() {
        ...
        return h `<button @click="${this.onClick}"><div class="wcm-icons">${r.map(n=>{const o=x.getWalletIcon(n);if(o)return h`<img crossorigin="anonymous" src="${o}">`;const i=x.getWalletIcon({id:n.id});return i?h` < img crossorigin = "anonymous"
...
tr.styles = [_.globalCss, ha], tr = ga([O("wcm-view-all-wallets-button")], tr);
const fa = P `.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
...
let xt = class extends A {
    ...
    render() {
        return h `<div class="wcm-qr-container">${this.uri?h`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${this.uri}" walletId="${D(this.walletId)}" imageId="${D(this.imageId)}"></wcm-qrcode>`:h`<wcm-spinner></wcm-spinner>`}</div>`
    }
};
xt.styles = [_.globalCss, fa], ie([$()], xt.prototype, "walletId", 2), ie([$()], xt.prototype, "imageId", 2), ie([W()], xt.prototype, "uri", 2), xt = ie([O("wcm-walletconnect-qr")], xt);
...
er.styles = [_.globalCss], er = ya([O("wcm-connect-wallet-view")], er);
const xa = P `wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var $a = Object.defineProperty,
    Ca = Object.getOwnPropertyDescriptor,
    to = (e, t, r, n) => {
        for (var o = n > 1 ? void 0 : n ? Ca(t, r) : t, i = e.length - 1, s; i >= 0; i--)(s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let se = class extends A {
    ...
    onFormatAndRedirect(e) {
        const {
            desktop: t,
            name: r
        } = C.getWalletRouterData(), n = t == null ? void 0 : t.native;
        if (n) {
    ...
    openDesktopApp() {
        const {
            walletConnectUri: e
        } = q.state, t = C.getWalletRouterData();
...
se.styles = [_.globalCss, xa], to([W()], se.prototype, "isError", 2), se = to([O("wcm-desktop-connecting-view")], se);
const Ea = P `wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
...
let rr = class extends A {
    ...
    render() {
        ...
        return h `<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${D(r)}" label="Not Detected" .isStale="${!0}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Download ${e} to continue. If multiple browser extensions are installed, disable non ${e} ones and try again`}</wcm-text><wcm-button .onClick="${()=>this.onInstall(n)}" .iconLeft="${S.ARROW_DOWN_ICON}">Download</wcm-button></wcm-info-footer>`
    }
};
rr.styles = [_.globalCss, Ea], rr = Oa([O("wcm-install-wallet-view")], rr);
const Ia = P `wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:96px;height:96px;margin-bottom:20px}wcm-info-footer{display:flex;width:100%}.wcm-app-store{justify-content:space-between}.wcm-app-store wcm-wallet-image{margin-right:10px;margin-bottom:0;width:28px;height:28px;border-radius:var(--wcm-wallet-icon-small-border-radius)}.wcm-app-store div{display:flex;align-items:center}.wcm-app-store wcm-button{margin-right:-10px}.wcm-note{flex-direction:column;align-items:center;padding:5px 0}.wcm-note wcm-text{text-align:center}wcm-platform-selection{margin-top:-15px}.wcm-note wcm-text{margin-top:15px}.wcm-note wcm-text span{color:var(--wcm-accent-color)}`;
var Ta = Object.defineProperty,
    ka = Object.getOwnPropertyDescriptor,
    eo = (e, t, r, n) => {
        for (var o = n > 1 ? void 0 : n ? ka(t, r) : t, i = e.length - 1, s; i >= 0; i--)(s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let ae = class extends A {
    ...
    onFormatAndRedirect(e, t = !1) {
        const {
            mobile: r,
            name: n
        } = C.getWalletRouterData(), o = r == null ? void 0 : r.native, i = r == null ? void 0 : r.universal;
        if (o && !t) {
    ...
    openMobileApp(e = !1) {
        const {
            walletConnectUri: t
        } = q.state, r = C.getWalletRouterData();
    ...
    render() {
        ...
        return h `<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${D(r)}" label="Tap 'Open' to continue…" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${i}" .isRetry="${!0}"><wcm-button .onClick="${()=>this.openMobileApp(!1)}" .iconRight="${S.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection>${a?h`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${()=>this.openMobileApp(!0)}">Try this alternate link</span></wcm-text>`:null}</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${t}" imageId="${D(r)}"></wcm-wallet-image><wcm-text>${`Get ${e}`}</wcm-text></div><wcm-button .iconRight="${S.ARROW_RIGHT_ICON}" .onClick="${()=>this.onGoToAppStore(s)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`
    }
};
ae.styles = [_.globalCss, Ia], eo([W()], ae.prototype, "isError", 2), ae = eo([O("wcm-mobile-connecting-view")], ae);
const Ma = P `wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var Pa = Object.defineProperty,
...
or.styles = [_.globalCss, Ma], or = Ra([O("wcm-mobile-qr-connecting-view")], or);
...
let nr = class extends A {
    render() {
        return h `<wcm-modal-header title="Scan the code" .onAction="${x.handleUriCopy}" .actionIcon="${S.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>`
    }
};
nr.styles = [_.globalCss], nr = Ba([O("wcm-qrcode-view")], nr);
const Da = P `wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
var Ua = Object.defineProperty,
    Wa = Object.getOwnPropertyDescriptor,
    jt = (e, t, r, n) => {
        for (var o = n > 1 ? void 0 : n ? Wa(t, r) : t, i = e.length - 1, s; i >= 0; i--)(s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let ht = class extends A {
    ...
    render() {
        ...
        return h `<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${G(l)}"><div class="wcm-grid">${n?null:i} ${n?null:s} ${n?null:r.map(c=>h`${c?h`<wcm-wallet-button imageId="${c.image_id}" name="${c.name}" walletId="${c.id}" .onClick="${()=>this.onConnect(c)}"></wcm-wallet-button>`:null}`)}</div><div class="wcm-placeholder-block">${a?h`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>`:null} ${!a&&this.loading?h`<wcm-spinner></wcm-spinner>`:null}</div></wcm-modal-content>`
    }
};
ht.styles = [_.globalCss, Da], jt([W()], ht.prototype, "loading", 2), jt([W()], ht.prototype, "firstFetch", 2), jt([W()], ht.prototype, "search", 2), jt([W()], ht.prototype, "endReached", 2), ht = jt([O("wcm-wallet-explorer-view")], ht);
const ja = P `wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
let le = class extends A {
    ...
    onFormatAndRedirect(e) {
        const {
            desktop: t,
            name: r
        } = C.getWalletRouterData(), n = t == null ? void 0 : t.universal;
        if (n) {
    ...
    render() {
        const {
            ...
            isMobile: n,
            isDesktop: o
        } = x.getCachedRouterWalletPlatforms(), i = C.isMobile();
...
le.styles = [_.globalCss, ja], ro([W()], le.prototype, "isError", 2), le = ro([O("wcm-web-connecting-view")], le);
export {
