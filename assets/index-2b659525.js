...
class It extends kt {
    constructor(e, t, r) {
        if (!ln(e)) throw new Error('"code" must be an integer such that: 1000 <= code <= 4999');
        super(e, t, r)
    }
}
...
we.serializeError = mn;

function bn(n) {
    return typeof n == "string" ? {
        message: n,
        code: pn.standardErrorCodes.rpc.internal
    } : (0, hn.isErrorResponse)(n) ? Object.assign(Object.assign({}, n), {
...
class qn {
    ...
    constructor(e) {
        ...
        s && this.updateListener.onAccountsUpdate({
            ...
            chain: i,
            source: "storage"
        }), this._accounts = s || [], this._activeChain = i || {
            ...
            case "wallet_switchEthereumChain":
                {
                    ...
                    const c = e.params,
                        l = (0, rt.ensureIntNumber)(c[0].chainId);this.stateManager.switchChain(l);
                    break
                }
        }
    }
...
function ke(n) {
    if (!Buffer.isBuffer(n))
        ...
        else if (typeof n == "string") Ht(n) ? n = Buffer.from(Xn(Kt(n)), "hex") : n = Buffer.from(n);
...
function Qn(n, e) {
    return n = ke(n), e || (e = 256), zn("keccak" + e).update(n).digest()
}
...
function R(n, e) {
    ...
    if (tr(n)) {
        ...
        if (n.startsWith("bytes")) {
            ...
            if (t = st(n), r = H(e), r < 0) throw new Error("Supplied ufixed is negative");
            return R("uint256", r * BigInt(2) ** BigInt(t[1]))
        } else if (n.startsWith("fixed")) return t = st(n), R("int256", H(e) * BigInt(2) ** BigInt(t[1]))
    }
...
function nr(n, e) {
    ...
    for (var i in n) {
        var a = $t(n[i]),
            o = e[i],
            c = R(a, o);
        er(a) ? (t.push(R("uint256", s)), r.push(c), s += c.length) : t.push(c)
    }
...
function Vt(n, e) {
    ...
    for (var t, r, s = [], i = 0; i < n.length; i++) {
        ...
        if (a === "bytes") s.push(o);
            ...
            if (t = G(a), t < 1 || t > 32) throw new Error("Invalid bytes<N> width: " + t);
            s.push(E.setLengthRight(o, t))
        } else if (a.startsWith("uint")) {
            if (t = G(a), t % 8 || t < 8 || t > 256) throw new Error("Invalid uint<N> width: " + t);
            r = H(o);
            ...
            if (t = G(a), t % 8 || t < 8 || t > 256) throw new Error("Invalid int<N> width: " + t);
            r = H(o);
            const c = E.bitLengthFromBigInt(r);
        ...
        encodeData(n, e, t, r = !0) {
            ...
            if (r) {
                ...
                for (const a of t[n]) {
                    let o = e[a.name];
                    if (o !== void 0)
                        if (a.type === "bytes") s.push("bytes32"), o = A.keccak(o), i.push(o);
                        else if (a.type === "string") s.push("bytes32"), typeof o == "string" && (o = Buffer.from(o, "utf8")), o = A.keccak(o), i.push(o);
                    else if (t[a.type] !== void 0) s.push("bytes32"), o = A.keccak(this.encodeData(a.type, o, t, r)), i.push(o);
                    else {
...
class cr {
    ...
    makeRequestId() {
        ...
        const e = this._nextRequestId,
            t = (0, or.prepend0x)(e.toString(16));
        return this.callbacks.get(t) && this.callbacks.delete(t), e
    }
}
ie.RelayEventManager = cr;
var Ie = {},
    Me = {},
    Le = {};
...
class dr {
    ...
    async decrypt(e) {
        ...
        return new Promise((r, s) => {
            (async function() {
                const i = await crypto.subtle.importKey("raw", (0, le.hexStringToUint8Array)(t), {
                        name: "aes-gcm"
                    }, !1, ["encrypt", "decrypt"]),
    ...
    async connect() {
        ...
        return new Promise((e, t) => {
            ...
            try {
                ...
                var a, o;
                if (i.data === "h")(a = this.incomingDataListener) === null || a === void 0 || a.call(this, {
                    type: "Heartbeat"
                });
                else try {
...
class fr {
    constructor({
        ...
        this.destroyed = !1, this.lastHeartbeatResponse = 0, this.nextReqId = (0, F.IntNumber)(1), this._connected = !1, this._linked = !1, this.shouldFetchUnseenEventsOnConnect = !1, this.requestResolutions = new Map, this.handleSessionMetadataUpdated = a => {
            if (!a) return;
            new Map([
                ...
                ["ChainId", c => a.JsonRpcUrl && this.handleChainUpdated(c, a.JsonRpcUrl)]
            ]).forEach((c, l) => {
                const h = a[l];
                h !== void 0 && c(h)
            })
        ...
        i.setConnectionStateListener(async a => {
            ...
            switch (a.type) {
                ...
                case "Linked":
                    {
                        const c = a.type === "IsLinkedOK" ? a.linked : void 0;this.linked = c || a.onlineGuests > 0;
                        break
                    }
...
var Er = M && M.__importDefault || function(n) {
...
(function(n) {
    ...
    class l {
        constructor() {
            this.items = new Map, this.nextItemKey = 0, this.root = null, this.darkMode = (0, i.isDarkMode)()
        }
        attach(p) {
    ...
    }, (0, r.h)("style", null, a.default), (0, r.h)("div", {
    ...
    const f = ({
        ...
        const [B, Xt] = (0, s.useState)(!0), [Oe, Qe] = (0, s.useState)(d ? ? !1);
        (0, s.useEffect)(() => {
...
class Nr {
    ...
    render(e) {
        this.root && ((0, x.render)(null, this.root), e && (0, x.render)((0, x.h)(Tr, Object.assign({}, e, {
            onDismiss: () => {
                this.clear()
            },
            darkMode: this.darkMode
...
const Tr = ({
    ...
    return (0, x.h)(Rr.SnackbarContainer, {
        darkMode: t
    }, (0, x.h)("div", {
        class: "-cbwsdk-redirect-dialog"
    }, (0, x.h)("style", null, Pr.default), (0, x.h)("div", {
...
class W {
    constructor(e) {
        this.accountsCallback = null, this.chainCallbackParams = {
            chainId: "",
            jsonRpcUrl: ""
        }, this.chainCallback = null, this.dappDefaultChain = 1, this.isMobileWeb = (0, Kr.isMobileWeb)(), this.appName = "", this.appLogoUrl = null, this.linkedUpdated = i => {
            this.isLinked = i;
    ...
    sendRequest(e) {
        ...
        return new Promise((i, a) => {
            t = this.ui.showConnecting({
                ...
                if (t == null || t(), (0, V.isErrorResponse)(o)) return a(new Error(o.errorMessage));
                i(o)
    ...
    openCoinbaseWalletDeeplink(e) {
        if (this.ui instanceof ut.WLMobileRelayUI) switch (e) {
    ...
    switchEthereumChain(e, t) {
        ...
        return new Promise((i, a) => {
            this.relayEventManager.callbacks.set(s, o => {
                if ((0, V.isErrorResponse)(o) && o.errorCode) return a($r.standardErrors.provider.custom({
                    code: o.errorCode,
...
var Vr = M && M.__importDefault || function(n) {
    return n && n.__esModule ? n : {
        default: n
    }
};
...
class Yr {
    ...
    async _wallet_addEthereumChain(e) {
        var t, r, s, i;
        const a = e[0];
        if (((t = a.rpcUrls) === null || t === void 0 ? void 0 : t.length) === 0) return {
            jsonrpc: "2.0",
            id: 0,
            error: {
                code: 2,
        ...
        if (!a.chainName || a.chainName.trim() === "") throw w.standardErrors.rpc.invalidParams("chainName is a required field");
        if (!a.nativeCurrency) throw w.standardErrors.rpc.invalidParams("nativeCurrency is a required field");
        const o = parseInt(a.chainId, 16);
        return await this.addEthereumChain(o, (r = a.rpcUrls) !== null && r !== void 0 ? r : [], (s = a.blockExplorerUrls) !== null && s !== void 0 ? s : [], a.chainName, (i = a.iconUrls) !== null && i !== void 0 ? i : [], a.nativeCurrency) ? {
            jsonrpc: "2.0",
            id: 0,
            result: null
        } : {
...
async function Qr(n, e) {
    ...
    return (await (await window.fetch(e.rpcUrl, {
        ...
        headers: {
            ...
            "X-Cbw-Sdk-Version": Jr.LIB_VERSION
        }
    })).json()).result
}
k.fetchRPCRequest = Qr;
...
k.getCoinbaseInjectedProvider = ts;
...
k.checkErrorForInvalidRequestArgs = ns;
...
const rs = _e,
    ...
    as = O,
    Jt = "SignerType",
    Qt = new as.ScopedLocalStorage("CBWSDK", "SignerConfigurator");
        ...
        case "extension":
            {
                ...
                if (!i) throw ss.standardErrors.rpc.internal("injected signer not found");
                return i
            }
    }
}
...
function gs(n) {
    const e = (window.innerWidth - ft) / 2 + window.screenX,
        ...
        r = window.open(n, "Smart Wallet", `width=${ft}, height=${mt}, left=${e}, top=${t}`);
    if (r == null || r.focus(), !r) throw hs.standardErrors.rpc.internal("Pop up window failed to open");
    return r
}
J.openPopup = gs;
...
class bs {
    constructor(e = ms.CB_KEYS_URL) {
        this.popup = null, this.listeners = new Map, this.postMessage = async t => {
            ...
            window.addEventListener("message", i), this.listeners.set(i, {
                reject: s
            })
        }), this.disconnect = () => {
            (0, bt.closePopup)(this.popup), this.popup = null, this.listeners.forEach(({
                reject: t
            }, r) => {
                t(yt.standardErrors.provider.userRejectedRequest("Request rejected")), window.removeEventListener("message", r)
            }), this.listeners.clear()
        }, this.waitForPopupLoaded = async () => this.popup && !this.popup.closed ? (this.popup.focus(), this.popup) : (this.popup = (0, bt.openPopup)(this.url), this.onMessage(({
            event: t
            ...
            this.postMessage({
                requestId: t.id,
                data: {
                    version: fs.LIB_VERSION
                }
            })
        }).then(() => {
            if (!this.popup) throw yt.standardErrors.rpc.internal();
            return this.popup
        })), this.url = new URL(e)
    }
}
...
function ys(n) {
    for (const e in wt) {
        const t = e;
        if (wt[t].includes(n)) return t
    }
}
je.determineMethodCategory = ys;
var ws = M && M.__rest || function(n, e) {
        var t = {};
    ...
    vs = M && M.__importDefault || function(n) {
        return n && n.__esModule ? n : {
            default: n
        }
    };
...
class Is extends _s.default {
    ...
    async disconnect() {
        this.accounts = [], this.chain = {
            id: 1
        }, ks.ScopedLocalStorage.clearAll(), this.emit("disconnect", z.standardErrors.provider.disconnected("User initiated disconnection"))
    }
